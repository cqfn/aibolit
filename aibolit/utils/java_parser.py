...
class ASTNode:
    def __init__(self, line: int, method_line: int, node: Any, scope: int) -> None:
...
class JavalangImproved:
    ...
    def __tree_to_nodes(
        ...
        line: int = 1,
        parent_method_line: int | None = None,
        scope: int = 0
    ) -> List[ASTNode]:
        """
        ...
        return [ASTNode(line, parent_method_line or line, tree, scope)] + res
