...
class Config(metaclass=Singleton):
    ...
    @staticmethod
    def folder_to_save_model_data() -> typing.Union[str, os.PathLike]:
    ...
    @staticmethod
    def folder_model_data() -> typing.Union[str, os.PathLike]:
    ...
    @staticmethod
    def dataset_file() -> typing.Union[str, os.PathLike]:
