...
df_patterns = pd.read_csv('./target/04/04-find-patterns.csv',
                          sep=';').set_index('filename')
df_readability = pd.read_csv('./target/05/05_readability.csv',
                             sep=';').set_index('filename')
df_halstead = pd.read_csv('./target/06/06_halstead_volume.csv',
                          sep=';').set_index('filename')
