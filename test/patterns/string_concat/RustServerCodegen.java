...
public class RustServerCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public CodegenOperation fromOperation(String path, String httpMethod, Operation operation, List<Server> servers) {
        ...
        // TO-FIX: 5.0: Remove the camelCased vendorExtension below and ensure templates use the newer property naming.
        ...
        op.vendorExtensions.put("operation_id", underscoredOperationId); // TO-FIX: 5.0 Remove
        op.vendorExtensions.put("x-operation-id", underscoredOperationId);
        op.vendorExtensions.put("uppercase_operation_id", underscoredOperationId.toUpperCase(Locale.ROOT)); // TO-FIX: 5.0 Remove
        ...
        op.vendorExtensions.put("path", vendorExtensionPath);  // TO-FIX: 5.0 Remove
        op.vendorExtensions.put("x-path",vendorExtensionPath);
        op.vendorExtensions.put("PATH_ID", pathId); // TO-FIX: 5.0 Remove
        op.vendorExtensions.put("x-path-id", pathId);
        op.vendorExtensions.put("hasPathParams", !op.pathParams.isEmpty()); // TO-FIX: 5.0 Remove
        ...
        op.vendorExtensions.put("HttpMethod", vendorExtensionHttpMethod); // TO-FIX: 5.0 Remove
        ...
        for (CodegenParameter param : op.headerParams) {
            ...
            param.vendorExtensions.put("typeName", toModelName(param.baseName)); // TO-FIX: 5.0 Remove
        ...
        for (CodegenResponse rsp : op.responses) {
            ...
            rsp.vendorExtensions.put("x-responseId", responseId); // TO-FIX: 5.0 Remove
            rsp.vendorExtensions.put("x-response-id", responseId);
            rsp.vendorExtensions.put("x-uppercaseResponseId", underscoredResponseId.toUpperCase(Locale.ROOT)); // TO-FIX: 5.0 Remove
            rsp.vendorExtensions.put("x-uppercase-response-id", underscoredResponseId.toUpperCase(Locale.ROOT));
            rsp.vendorExtensions.put("uppercase_operation_id", underscoredOperationId.toUpperCase(Locale.ROOT)); // TO-FIX: 5.0 Remove
            ...
            if (rsp.dataType != null) {
                ...
                rsp.vendorExtensions.put("uppercase_data_type", uppercaseDataType); // TO-FIX: 5.0 Remove
                ...
                rsp.vendorExtensions.put("mimeType", outputMime); // TO-FIX: 5.0 Remove
                rsp.vendorExtensions.put("x-mime-type", outputMime);

                // Write out the type of data we actually expect this response
                // to make.
                if (producesXml) {
                    rsp.vendorExtensions.put("producesXml", true); // TO-FIX: 5.0 Remove
                    ...
                    // 'producesBytes'.
                    if (rsp.dataType.equals(bytesType)) {
                        rsp.vendorExtensions.put("producesBytes", true); // TO-FIX: 5.0 Remove
                        rsp.vendorExtensions.put("x-produces-bytes", true);
                    } else {
                        rsp.vendorExtensions.put("producesPlainText", true); // TO-FIX: 5.0 Remove
                        rsp.vendorExtensions.put("x-produces-plain-text", true);
                    }
                } else {
                    rsp.vendorExtensions.put("producesJson", true); // TO-FIX: 5.0 Remove
                ...
                if (response != null && (!StringUtils.isEmpty(response.get$ref()))) {
                    ...
                    if ((model != null)) {
                        ...
                        if ((xml != null) && (xml.getNamespace() != null)) {
                            rsp.vendorExtensions.put("has_namespace", "true"); // TO-FIX: 5.0 Remove
    ...
    public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
        ...
        for (CodegenOperation op : operationList) {
                ...
                for (Map<String, String> consume : op.consumes) {
                    if (consume.get("mediaType") != null) {
                        ...
                        if (isMimetypeXml(mediaType)) {
                            ...
                            op.vendorExtensions.put("consumesMultipart", true); // TO-FIX: 5.0 Remove
            ...
            if (op.bodyParam != null) {
                ...
                op.bodyParam.vendorExtensions.put("uppercase_operation_id", underscoredOperationId); // TO-FIX: 5.0 Remove
                op.bodyParam.vendorExtensions.put("x-uppercase-operation-id", underscoredOperationId);
                if (consumesXml) {
                    op.bodyParam.vendorExtensions.put("consumesXml", true); // TO-FIX: 5.0 Remove
                    op.bodyParam.vendorExtensions.put("x-consumes-xml", true);
                } else if (consumesPlainText) {
                    op.bodyParam.vendorExtensions.put("consumesPlainText", true); // TO-FIX: 5.0 Remove
                    op.bodyParam.vendorExtensions.put("x-consumes-plain-text", true);
                } else {
                    op.bodyParam.vendorExtensions.put("consumesJson", true); // TO-FIX: 5.0 Remove
            ...
            for (CodegenParameter param : op.bodyParams) {
                ...
                param.vendorExtensions.put("uppercase_operation_id", underscoredOperationId); // TO-FIX: 5.0 Remove
                ...
                if (consumesXml) {
                    param.vendorExtensions.put("consumesXml", true); // TO-FIX: 5.0 Remove
                    param.vendorExtensions.put("x-consumes-xml", true);
                } else if (consumesPlainText) {
                    param.vendorExtensions.put("consumesPlainText", true); // TO-FIX: 5.0 Remove
                    param.vendorExtensions.put("x-consumes-plain-text", true);
                } else {
                    param.vendorExtensions.put("consumesJson", true); // TO-FIX: 5.0 Remove
            ...
            if (op.authMethods != null) {
                ...
                for (CodegenSecurity s : op.authMethods) {
                    if (s.isApiKey && s.isKeyInHeader) {
                        s.vendorExtensions.put("x-apiKeyName", toModelName(s.keyParamName)); // TO-FIX: 5.0 Remove
                ...
                if (headerAuthMethods) {
                    op.vendorExtensions.put("hasHeaderAuthMethods", "true"); // TO-FIX: 5.0 Remove
    ...
    public CodegenModel fromModel(String name, Schema model) {
        ...
        mdl.vendorExtensions.put("upperCaseName", name.toUpperCase(Locale.ROOT)); // TO-FIX: 5.0 Remove
        ...
        if (ModelUtils.isArraySchema(model)) {
            ...
            if (xmlName != null) {
                mdl.vendorExtensions.put("itemXmlName", xmlName); // TO-FIX: 5.0 Remove
    ...
    public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
        ...
        for (Entry<String, CodegenModel> entry : allModels.entrySet()) {
            ...
            for (CodegenProperty prop : model.vars) {
                ...
                if (xmlName != null) {
                    prop.vendorExtensions.put("itemXmlName", xmlName); // TO-FIX: 5.0 Remove
    ...
    public Map<String, Object> postProcessModels(Map<String, Object> objs) {
        ...
        for (Object _mo : models) {
            ...
            cm.vendorExtensions.put("isString", "String".equals(cm.dataType)); // TO-FIX: 5.0 Remove
    ...
    private void processParam(CodegenParameter param, CodegenOperation op) {
        ...
        if (param.isString) {
            param.vendorExtensions.put("formatString", "\\\"{}\\\""); // TO-FIX: 5.0 Remove
            param.vendorExtensions.put("x-format-string", "\\\"{}\\\""); // TO-FIX: 5.0 Remove
        ...
        if (param.required) {
            if (example != null) {
                param.vendorExtensions.put("example", example); // TO-FIX: 5.0 Remove
                param.vendorExtensions.put("x-example", example);
            } else if (param.isListContainer) {
                // Use the empty list if we don't have an example
                param.vendorExtensions.put("example", "&Vec::new()"); // TO-FIX: 5.0 Remove
                ...
                param.vendorExtensions.put("example", "???"); // TO-FIX: 5.0 Remove
                param.vendorExtensions.put("x-example", "???");
                op.vendorExtensions.put("noClientExample", Boolean.TRUE); // TO-FIX: 5.0 Remove
            ...
            param.vendorExtensions.put("formatString", "{:?}"); // TO-FIX: 5.0 Remove
            param.vendorExtensions.put("x-format-string", "{:?}");
            param.vendorExtensions.put("example", "None"); // TO-FIX: 5.0 Remove
            ...
            param.vendorExtensions.put("example", exampleString); // TO-FIX: 5.0 Remove
