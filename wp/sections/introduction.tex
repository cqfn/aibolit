...
and quantification through compliance with requirements, passing or failing
tests, and the number of defects observed during verification or
operation~\citep{Farhan,The_Economics_of_Software_Quality}. Functional quality
is also an essential requirement in any domain of software development. On the
other hand, maintainability is a lot less straightforward to formally specify
or quantify, because the research community still lacks a single precise and
universally accepted definition of this quality
attribute~\citep{Broy2006DemystifyingM,Software_quality_the_elusive_target}.
Also, in safety-critical, security-critical, or mission-critical applications,
functional correctness often dominates other concerns, although in the business
domain maintainability is recognized as an essential property because software
evolves frequently and a large part of its lifetime cost is caused by
maintenance~\citep{The_Economics_of_Software_Quality}.
